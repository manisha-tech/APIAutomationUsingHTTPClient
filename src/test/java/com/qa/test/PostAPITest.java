...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		//object to json file:
		mapper.writeValue(new File("C:\\Users\\manis\\eclipse-workspace\\RestAPI_Testing\\src\\main\\java\\com\\qa\\data\\users.json"), users);
			
		//Marshalling-----> converting java object to json in String:
		...
		//unMarshalling-----> converting json to java object:
